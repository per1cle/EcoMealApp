...
namespace EcoMeal.DataAccess.Migrations
{
    ...
    [Migration("20260707134754_SeedInitialData")]
            ...
            modelBuilder.Entity("EcoMeal.DataAccess.Entities.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e377abc4-1106-4802-a945-8f5b275c3316"),
                            ...
                            PickupEnd = new DateTime(2026, 7, 7, 20, 0, 0, 0, DateTimeKind.Local),
                            PickupStart = new DateTime(2026, 7, 7, 18, 0, 0, 0, DateTimeKind.Local),
                            Price = 15.5m,
                            Quantity = 5
                        },
                        new
                        {
                            Id = new Guid("5abcdcf0-d006-4222-86af-d0b15c55c0cd"),
                            ...
                            PickupEnd = new DateTime(2026, 7, 7, 20, 0, 0, 0, DateTimeKind.Local),
                            PickupStart = new DateTime(2026, 7, 7, 16, 0, 0, 0, DateTimeKind.Local),
                            Price = 3.5m,
                            Quantity = 20
                        });
                });
            ...
            modelBuilder.Entity("EcoMeal.DataAccess.Entities.PackageType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("9cab424e-fb07-4777-ac7b-c8d72bf2f803"),
                            Name = "Vegan Bag"
                        },
                        new
                        {
